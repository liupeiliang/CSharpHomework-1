    ...
    public class OrderService
    {
        ...
        public string addOrder(string client, string name, string id, int price)
        {
            ...
            else
            {
                ...
                Order order = new Order(client, name, id, price);
        ...
        public void deleteOrder(int id)
        {
            ...
            using (var db = new Model1())
            {
                var oder = db.Order.SingleOrDefault(o => o.id.Equals(id));
                db.Order.Remove(oder);
                db.SaveChanges();
            }
        ...
        public Order searchOrder(int id)
        {
            ...
            using (var db = new Model1())
            {
                return db.Order.SingleOrDefault(o => o.id.Equals(id));
            }
